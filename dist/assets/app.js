...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"normalize.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var imageDatas = __webpack_require__(170);
	  ...
	  _createClass(ImgFigure, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { src: this.props.data.src, alt: this.props.data.title }),
	...
	var ControllerUnit = function (_React$Component2) {
	  ...
	  function ControllerUnit(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ControllerUnit).call(this, props));
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      imageDatas.map(function (value, index) {
	        ...
	        imgFigures.push(_react2.default.createElement(ImgFigure, { key: index, data: value, ref: 'imgFigure' + index, arrange: _this6.state.imgsArrangeArr[index], inverse: _this6.inverse(index), center: _this6.center(index) }));
	        controllerUnits.push(_react2.default.createElement(ControllerUnit, { key: index, arrange: _this6.state.imgsArrangeArr[index], inverse: _this6.inverse(index), center: _this6.center(index) }));
	      });
	      return _react2.default.createElement(
	        'section',
